...
if _es_home and not st.session_state.get("nicho_guardado") and not st.session_state.get("producto_servicio"):
    ...
    _RUTAS_ES = [
        {"icon": "\U0001f3ea", "label": "Tengo una tienda", "steps": [
            ("1\ufe0f\u20e3 Configura tu perfil", "Completa tu marca, nicho y qué vendes en el panel izquierdo."),
            ("2\ufe0f\u20e3 Analiza tu competencia", "Toca el agente 🎯 Competencia → Inteligencia Competitiva"),
            ("3\ufe0f\u20e3 Crea contenido de catálogo", "Toca el agente 📣 Publicidad → Campaña por Catálogo"),
            ("4\ufe0f\u20e3 Cierra más ventas", "Toca el agente 💰 Ventas → Psicólogo de Precios"),
        ]},
        {"icon": "\U0001f4bc", "label": "Soy freelancer o agencia", "steps": [
            ("1\ufe0f\u20e3 Define tu cliente ideal", "Panel izquierdo → botón Detectar Cliente"),
            ("2\ufe0f\u20e3 Crea tu embudo de ventas", "Toca el agente 💰 Ventas → Embudo de Ventas"),
            ("3\ufe0f\u20e3 Genera cotizaciones", "Toca el agente 💰 Ventas → Cotizaciones"),
            ("4\ufe0f\u20e3 Protege tu trabajo", "Toca el agente 📋 Gestión → Contratos"),
        ]},
        {"icon": "\U0001f3ac", "label": "Soy creador de contenido", "steps": [
            ("1\ufe0f\u20e3 Planifica tu semana", "Toca el agente 🧠 Estrategia → Plan de Contenido Semanal"),
            ("2\ufe0f\u20e3 Domina TikTok/Reels", "Toca el agente ✍️ Contenido → Experto TikTok/Reels"),
            ("3\ufe0f\u20e3 Audita tu contenido", "Toca el agente 🖼️ Imágenes → Auditoría Visual (Video/Foto)"),
            ("4\ufe0f\u20e3 Conoce a tu competencia", "Toca el agente 🎯 Competencia → Inteligencia Competitiva"),
        ]},
        {"icon": "\U0001f6e0\ufe0f", "label": "Vendo servicios", "steps": [
            ("1\ufe0f\u20e3 Define tu cliente ideal", "Panel izquierdo → botón Detectar Cliente"),
            ("2\ufe0f\u20e3 Construye tu marca", "Toca el agente ✍️ Contenido → Storytelling de Marca"),
            ("3\ufe0f\u20e3 Mata las objeciones", "Toca el agente 💰 Ventas → Mata-Objeciones"),
            ("4\ufe0f\u20e3 Optimiza tus precios", "Toca el agente 💰 Ventas → Psicólogo de Precios"),
        ]},
        {"icon": "\U0001f37d\ufe0f", "label": "Tengo un restaurante", "steps": [
            ("1\ufe0f\u20e3 Configura nicho Gastronomía", "Panel izquierdo → Nicho → Gastronomía"),
            ("2\ufe0f\u20e3 Detecta tendencias locales", "Toca el agente 🧠 Estrategia → Radar de Tendencias Virales"),
            ("3\ufe0f\u20e3 Muestra tu menú", "Toca el agente 📣 Publicidad → Campaña por Catálogo"),
            ("4\ufe0f\u20e3 Atrae clientes locales", "Toca el agente 📣 Publicidad → Segmentación de Ads"),
        ]},
        {"icon": "\U0001f331", "label": "Estoy empezando desde cero", "steps": [
            ("1\ufe0f\u20e3 Configura tu perfil básico", "Panel izquierdo → completa marca, nicho, qué vendes"),
            ("2\ufe0f\u20e3 Detecta tu potencial", "Toca el agente 🧠 Estrategia → Auditoría Maestra del Negocio"),
            ("3\ufe0f\u20e3 Planifica tu primer contenido", "Toca el agente 🧠 Estrategia → Plan de Contenido Semanal"),
            ("4\ufe0f\u20e3 Conoce a tu cliente", "Toca el agente 💰 Ventas → Embudo de Ventas"),
        ]},
    ]
    _RUTAS_EN = [
        {"icon": "\U0001f3ea", "label": "I have a store", "steps": [
            ("1\ufe0f\u20e3 Set up your profile", "Fill in your brand, niche and what you sell in the left panel."),
            ("2\ufe0f\u20e3 Analyze your competition", "Tap the 🎯 Competitors agent → Competitive Intelligence"),
            ("3\ufe0f\u20e3 Create catalog content", "Tap the 📣 Advertising agent → Catalog Campaign"),
            ("4\ufe0f\u20e3 Close more sales", "Tap the 💰 Sales agent → Price Psychology"),
        ]},
        {"icon": "\U0001f4bc", "label": "I'm a freelancer or agency", "steps": [
            ("1\ufe0f\u20e3 Define your ideal client", "Left panel → Detect Client button"),
            ("2\ufe0f\u20e3 Build your sales funnel", "Tap the 💰 Sales agent → Sales Funnel"),
            ("3\ufe0f\u20e3 Generate quotes", "Tap the 💰 Sales agent → Quotes"),
            ("4\ufe0f\u20e3 Protect your work", "Tap the 📋 Management agent → Contracts"),
        ]},
        {"icon": "\U0001f3ac", "label": "I'm a content creator", "steps": [
            ("1\ufe0f\u20e3 Plan your week", "Tap the 🧠 Strategy agent → Weekly Content Plan"),
            ("2\ufe0f\u20e3 Master TikTok/Reels", "Tap the ✍️ Content agent → TikTok/Reels Expert"),
            ("3\ufe0f\u20e3 Audit your content", "Tap the 🖼️ Images agent → Visual Audit (Video/Photo)"),
            ("4\ufe0f\u20e3 Know your competition", "Tap the 🎯 Competitors agent → Competitive Intelligence"),
        ]},
        {"icon": "\U0001f6e0\ufe0f", "label": "I sell services", "steps": [
            ("1\ufe0f\u20e3 Define your ideal client", "Left panel → Detect Client button"),
            ("2\ufe0f\u20e3 Build your brand", "Tap the ✍️ Content agent → Brand Storytelling"),
            ("3\ufe0f\u20e3 Crush objections", "Tap the 💰 Sales agent → Objection Buster"),
            ("4\ufe0f\u20e3 Optimize your prices", "Tap the 💰 Sales agent → Price Psychology"),
        ]},
        {"icon": "\U0001f37d\ufe0f", "label": "I have a restaurant", "steps": [
            ("1\ufe0f\u20e3 Set niche to Gastronomy", "Left panel → Niche → Gastronomy"),
            ("2\ufe0f\u20e3 Detect local trends", "Tap the 🧠 Strategy agent → Viral Trends Radar"),
            ("3\ufe0f\u20e3 Showcase your menu", "Tap the 📣 Advertising agent → Catalog Campaign"),
            ("4\ufe0f\u20e3 Attract local customers", "Tap the 📣 Advertising agent → Ads Segmentation"),
        ]},
        {"icon": "\U0001f331", "label": "I'm starting from scratch", "steps": [
            ("1\ufe0f\u20e3 Set up your basic profile", "Left panel → fill in brand, niche, what you sell"),
            ("2\ufe0f\u20e3 Detect your potential", "Tap the 🧠 Strategy agent → Master Business Audit"),
            ("3\ufe0f\u20e3 Plan your first content", "Tap the 🧠 Strategy agent → Weekly Content Plan"),
            ("4\ufe0f\u20e3 Know your customer", "Tap the 💰 Sales agent → Sales Funnel"),
        ]},
    ]
